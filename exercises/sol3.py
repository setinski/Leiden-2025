...
def simple_enumeration(B, t, l):
	...
	# Return the closest lattice vector found
    return c
...
def fincke_pohst_1d_enumeration(b1, x, t, r):
    ...
    upper = int(np.ceil(-offset + r_norm))
...
def fincke_pohst_enumeration(B, t, r):
    ...
    if n == 1:
        return fincke_pohst_1d_enumeration(B[0], np.zeros_like(t), t, r)
