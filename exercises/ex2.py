...
# The test file (test_ex2.py) doesn't work in some cases of higher dimension
# (one time only dimension 4,
# but one time also dimension 2. I didn't know how to solve it.
# I think I did something wrong with taking the transpose
...
def in_lattice(B, v):
    ...
    #I dont understand why we have to compute B^T * v
    BT = np.transpose(B)
